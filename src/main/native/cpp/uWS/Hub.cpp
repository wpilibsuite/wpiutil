...
bool Hub::listen(const char *host, int port, void* sslContext, int options, Group<SERVER> *eh) {
    if (!eh) {
...
bool Hub::listen(int port, void* sslContext, int options, Group<SERVER> *eh) {
...
void Hub::upgrade(uv_os_sock_t fd, const char *secKey, void *ssl, const char *extensions, size_t extensionsLength, const char *subprotocol, size_t subprotocolLength, Group<SERVER> *serverGroup) {
    if (!serverGroup) {
