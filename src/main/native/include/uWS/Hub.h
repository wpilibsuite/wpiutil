...
public:
    ...
    bool listen(int port, void* sslContext = nullptr, int options = 0, Group<SERVER> *eh = nullptr);
    bool listen(const char *host, int port, void* sslContext = nullptr, int options = 0, Group<SERVER> *eh = nullptr);
    ...
    void upgrade(uv_os_sock_t fd, const char *secKey, void *ssl, const char *extensions, size_t extensionsLength, const char *subprotocol, size_t subprotocolLength, Group<SERVER> *serverGroup = nullptr);
